...
public class Menu extends JPanel implements Runnable {
    Thread thread;
    private BufferedImage imgBg = Resource.getResourceImage("img/bc2.jpg");
    private BufferedImage Police1 = Resource.getResourceImage("img/fla.png");
    private BufferedImage Police2 = Resource.getResourceImage("img/fla2.png");
