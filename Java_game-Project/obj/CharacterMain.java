...
public class CharacterMain {
    ...
    public CharacterMain() {
        ...
        charecterRun.addFrame(Resource.getResourceImage("img/luffy.png"));
        charecterRun.addFrame(Resource.getResourceImage("img/luffy.png"));
        charecterRun.addFrame(Resource.getResourceImage("img/luffy2.png"));
        ImageJump = Resource.getResourceImage("img/luffyJump.png");
        ImageJump2 = Resource.getResourceImage("img/luffyJump2.png");
        rect = new Rectangle();
    }
